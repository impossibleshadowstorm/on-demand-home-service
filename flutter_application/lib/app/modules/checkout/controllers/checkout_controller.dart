...
class CheckoutController extends GetxController {
  ...
  final booking = new Booking(id: '').obs;
  Rx<PaymentMethod> selectedPaymentMethod = new PaymentMethod(id: '').obs;
  ...
  void payBooking(Booking _booking) async {
    try {
      _booking.payment =
          new Payment(paymentMethod: selectedPaymentMethod.value, id: '');
