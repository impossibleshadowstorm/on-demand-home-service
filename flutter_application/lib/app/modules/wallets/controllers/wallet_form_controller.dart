...
class WalletFormController extends GetxController {
  ...
  void _initWallet({required Map<String, dynamic> arguments}) {
    if (arguments != null) {
      wallet.value = (arguments['wallet'] as Wallet) ?? Wallet(id: '');
    } else {
      wallet.value = new Wallet(id: '');
    }
  }
